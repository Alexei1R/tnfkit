...
extension RecordLayerView {
    fileprivate func createRecordButton() -> some View {
        Button(action: {
    ...
    fileprivate func createEndScanPopUp() -> some View {
        VStack(spacing: 18) {
            Text("Save Recording")
                .font(.headline)
                .foregroundColor(.white)
            ...
            VStack(spacing: 16) {
                ...
                TextField(
                    ...
                    prompt: Text("Default").foregroundColor(.gray)
                )
                .foregroundColor(.white)
                .padding(12)
                .background(
